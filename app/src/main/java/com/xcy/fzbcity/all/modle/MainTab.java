...
import com.xcy.fzbcity.all.fragment.TestFragment;

public enum  MainTab {


    RECENT_CONTACTS(0, ReminderId.SESSION, TestFragment.class, R.string.main_tab_session, R.layout.session_list_new);
