...
import com.xcy.fzbcity.all.myim.GuessAttachment;
...
import com.xcy.fzbcity.all.myim.ReminderManager;
...
import com.xcy.fzbcity.all.view.MultiportActivity;
 ...
 */
public class TestFragment extends MainTabFragment {
    ...
    Observer<List<OnlineClient>> clientsObserver = new Observer<List<OnlineClient>>() {
        ...
        public void onEvent(List<OnlineClient> onlineClients) {
            Log.i("测试","onlineClients");
            TestFragment.this.onlineClients = onlineClients;
    ...
    private void addRecentContactsFragment() {
        ...
        fragment.setCallback(new RecentContactsCallback() {
            ...
            public void onRecentContactsLoaded() {
                Log.i("测试","onRecentContactsLoaded");
                // 最近联系人列表加载完毕
            }

            @Override
            public void onUnreadCountChange(int unreadCount) {
                Log.i("测试","unreadCount:" + unreadCount);
                ReminderManager.getInstance().updateSessionUnreadNum(unreadCount);
            }

            @Override
            public void onItemClick(RecentContact recent) {
                Log.i("测试","recent:" + recent);
            ...
            public String getDigestOfAttachment(RecentContact recentContact, MsgAttachment attachment) {
                ...
                Log.i("测试","attachment:" + attachment);
                if (attachment instanceof GuessAttachment) {
                    ...
                    return "[聊天记录]";
                }else if(attachment instanceof ProjectCustomAttachment){
                    return "[项目消息]";
                }
