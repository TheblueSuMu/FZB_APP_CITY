...
import com.xcy.fzbcity.all.fragment.MyClientFragment1;
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.client_add:
                ...
                //      监听选中
                OptionsPickerView pvOptions = new OptionsPickerBuilder(MyClientActivity.this, new OnOptionsSelectListener() {
                    @Override
