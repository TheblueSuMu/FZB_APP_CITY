...
public class ProcessDataAdapter extends RecyclerView.Adapter<ProcessDataAdapter.ClientFragmentViewHolder> {

    List<ProcessDataBean.DataBean.RowsBean> rows;
    private Context context;


    public void setRows(List<ProcessDataBean.DataBean.RowsBean> rows) {
        this.rows = rows;
    }
    ...
    public void onBindViewHolder(@NonNull ClientFragmentViewHolder holder, final int position) {
        ...
        holder.client_item_photo.setText("(" + rows.get(position).getAgentPhone() + ")");
