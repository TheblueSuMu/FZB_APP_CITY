...
//        config.notificationColor = DemoCache.getContext().getResources().getColor(R.color.color_blue_3a9efb);
    ...
    private static MixPushConfig buildMixPushConfig() {
        ...
        // 小米推送
        config.xmAppId = "2882303761518341491";
        config.xmAppKey = "5281834134491";
        config.xmCertificateName = "XMCertificate";


        // 华为推送
        config.hwAppId = "101651787";
        config.hwCertificateName = "HWCertificate";


        // 魅族推送
        config.mzAppId = "128676";
        config.mzAppKey = "8cfb272ed62c432488875206c3033bc6";
        config.mzCertificateName = "FlymeCertificate";
...
//
        // oppo推送
        config.oppoAppId = "30253382";
        config.oppoAppKey = "fb33f01d3bb3423a87db4b2bc065d747";
        config.oppoAppSercet = "fb33f01d3bb3423a87db4b2bc065d747";
        config.oppoCertificateName = "OppoCertificate";
        return config;
    }
}
