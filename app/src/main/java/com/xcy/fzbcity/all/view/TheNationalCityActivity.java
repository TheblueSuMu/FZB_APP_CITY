...
import com.xcy.fzbcity.all.adapter.SortAdapter;
...
public class TheNationalCityActivity extends AppCompatActivity implements View.OnClickListener {

    TextView national_city_tv1;
    TextView national_city_tv2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_the_national_city);
    ...
    private void initView() {
        ...
        mCityTextSearch = (CleanableEditView) findViewById(com.lljjcoder.style.citypickerview.R.id.cityInputText);
        sortListView = (ListView) findViewById(com.lljjcoder.style.citypickerview.R.id.country_lvcountry);
        mDialog = (TextView) findViewById(com.lljjcoder.style.citypickerview.R.id.dialog);
        mSidrbar = (SideBar) findViewById(com.lljjcoder.style.citypickerview.R.id.sidrbar);


        national_city_tv1 = findViewById(R.id.national_city_tv1);
        national_city_tv2 = findViewById(R.id.national_city_tv2);
        national_city_tv2.setText(FinalContents.getNationalCityName());
        national_city_tv1.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.national_city_tv1://取消
                FinalContents.setNationalCityNameSearch("");
                finish();
                break;
        }
    ...
    private void setCityData(List<CityInfoBean> cityList) {
        ...
        Log.i("城市列表","长度：" + cityListInfo.size());
        for (int i = 0; i < cityListInfo.size(); ++i){
            Log.i("城市列表",cityListInfo.get(i).getName());
        }
    ...
    private void initList() {
        ...
        adapter = new SortAdapter(TheNationalCityActivity.this, sourceDateList);
        ...
        sortListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                FinalContents.setNationalCityName(cityName);
                FinalContents.setNationalCityNameSearch("");
                Log.i("全国城市","cityName:" + cityName);
                finish();
            }
        });
        ...
        mCityTextSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                FinalContents.setNationalCityNameSearch(s.toString());
