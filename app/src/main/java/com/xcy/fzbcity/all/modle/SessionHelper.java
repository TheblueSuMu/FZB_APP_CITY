...
import com.xcy.fzbcity.all.myim.MultiRetweetAttachment;
import com.xcy.fzbcity.all.myim.RTSAttachment;
import com.xcy.fzbcity.all.myim.RedPacketAttachment;
import com.xcy.fzbcity.all.myim.RedPacketOpenedAttachment;
import com.xcy.fzbcity.all.myim.SnapChatAttachment;
import com.xcy.fzbcity.all.myim.StickerAttachment;
import com.xcy.fzbcity.all.myim.cyy.myCyyAction;
import com.xcy.fzbcity.all.myim.file.FileAction;
import com.xcy.fzbcity.all.myim.file.MsgViewHolderFile;
import com.xcy.fzbcity.all.myim.itemclick.MsgViewHolderMultiRetweet;
import com.xcy.fzbcity.all.myim.project.ProjectCustomAttachParser;
import com.xcy.fzbcity.all.myim.project.ProjectCustomAttachment;
import com.xcy.fzbcity.all.myim.project.ProjectMsgViewHolderCrops;
import com.xcy.fzbcity.all.myim.project.projectAction;
...
public class SessionHelper {
    ...
    public static void init() {
        ...
        NIMClient.getService(MsgService.class).registerCustomAttachmentParser(new ProjectCustomAttachParser());//发送项目
...
//            }
            actions.add(new FileAction());//文件
//            actions.add(new voiceAction());//语音
//            actions.add(new videoAction());//视频
            actions.add(new projectAction());//项目
            actions.add(new myCyyAction());//常用语
...
//            buttons.add(infoButton);
    ...
    private static SessionCustomization getMyP2pCustomization() {
        Log.i("聊天", "getMyP2pCustomization");
...
//            }
    ...
    private static void registerViewHolders() {
        ...
        NimUIKit.registerMsgItemViewHolder(ProjectCustomAttachment.class, ProjectMsgViewHolderCrops.class);//发送项目
            ...
            public boolean shouldIgnore(IMMessage message) {
                if (message.getDirect() == MsgDirectionEnum.In
                    ...
                    return true;
                        ...
                        // 添加此处判断
                        || message.getAttachment() instanceof ProjectCustomAttachment)) {
