...
import com.xcy.fzbcity.all.modle.LabelBean;

import java.util.List;

public class Project_Label_Adapter extends RecyclerView.Adapter<Project_Label_Adapter.ViewHolder>{
    private View view;
    ...
    public Project_Label_Adapter(List<LabelBean.DataBean> list) {
        this.list = list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_project_label, parent, false);
