...
//            // resend的的情况，可能时间已经变化了，这里要重新检查是否要显示时间
    ...
    private class MsgItemEventListener extends MsgAdapter.BaseViewHolderEventListener {
        ...
        public boolean onViewHolderLongClick(View clickView, View viewHolderView, IMMessage item) {
            viewHolderView1 = viewHolderView;
...
//            View popupView = LayoutInflater.from(container.activity).inflate(R.layout.layout_pop, null);
//            Button preBt = (Button) popupView.findViewById(R.id.bt_l);
//            Button nextBt = (Button) popupView.findViewById(R.id.bt_r);
//            Button sBt = (Button) popupView.findViewById(R.id.bt_s);
...
//            viewHolderView1.getLocationOnScreen(location);
//            popupWindow.showAtLocation(viewHolderView1, Gravity.NO_GRAVITY, (location[0] + viewHolderView1.getWidth() / 2) - popupWidth / 2,
//                    location[1] - 100);
//            Log.i("屏幕距離","location[0]：" + location[0]);
//            Log.i("屏幕距離","location[1]：" + location[1]);
//            Log.i("屏幕距離","popupWidth / 2：" + popupWidth / 2);
//            Log.i("屏幕距離","viewHolderView1.getWidth() / 2：" + viewHolderView1.getWidth() / 2);
//
...
//                @Override
//                public void onClick(View v) {
//                    ClipboardUtil.clipboardCopyText(container.activity, selectedItem.getContent());
//
//                    popupWindow.dismiss();
//                }
//            });
